...
private:
  ...
  tier4_api_utils::Service<autoware_external_api_msgs::srv::SetDoor>::SharedPtr srv_;
  tier4_api_utils::Client<autoware_external_api_msgs::srv::SetDoor>::SharedPtr cli_;
