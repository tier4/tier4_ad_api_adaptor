...
上記を除けば使用方法に大きな変更はない。
詳細は[Localization API](https://autowarefoundation.github.io/autoware-documentation/main/design/autoware-architecture-v1/interfaces/ad-api/features/localization/)を参照のこと。
